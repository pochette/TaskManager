...
public class KVTaskClient {
    ...
    private String saveUrl(String url, String key) {
        if(apiKey == null) {
            throw new IllegalStateException("Call KVTaskClient.register() before saving data");
        }
        return String.format("%s/save/%s", this.url, key);
    }
    private String loadUrl(String key) {
        if (apiKey==null){
            throw new IllegalStateException("Call KVTaskClient.register() before loading data");
        }
    ...
    public void register() {
        ...
        try {
            ...
            throw new IllegalStateException("Failed to register KVTaskClient");
        }
    }
}
